...
class _ProductosScreenState extends State<ProductosScreen> {
  ...
  Future<void> _buscar({int pagina = 1}) async {
    ...
    final res = await context
        .read<Session>()
        .api
        .getProductos(q: _buscador.text.trim(), orden: _orden, pagina: pagina);
    if (!mounted) return;
    if (res.ok) {
      setState(() {
        ...
        Expanded(
          ...
          child: ListView(padding: const EdgeInsets.all(16), children: [
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: const [
                        DropdownMenuItem(
                            value: 'relevancia', child: Text('Selección CAVA')),
                        DropdownMenuItem(
                            value: 'precio_asc',
                        ...
                        DropdownMenuItem(
                            value: 'alfabetico', child: Text('Nombre: A a Z')),
                      ],
                      onChanged: (v) {
            ...
            if (_cargando)
              ...
              _StateCard(
                  icon: Icons.cloud_off, text: _error!, action: () => _buscar())
